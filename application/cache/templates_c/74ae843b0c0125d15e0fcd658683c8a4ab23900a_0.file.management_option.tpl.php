<?php
/* Smarty version 3.1.29, created on 2022-03-21 12:56:22
  from "/home/admin/web/lastikkent.com.tr/public_html/application/views/admin/management_option.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_62384bc68cb4f9_37513567',
  'file_dependency' => 
  array (
    '74ae843b0c0125d15e0fcd658683c8a4ab23900a' => 
    array (
      0 => '/home/admin/web/lastikkent.com.tr/public_html/application/views/admin/management_option.tpl',
      1 => 1492518464,
      2 => 'file',
    ),
  ),
...
function content_62384bc68cb4f9_37513567 ($_smarty_tpl) {
                        ...
                        <form role="form" method="post">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="username" value="<?php if ($_smarty_tpl->tpl_vars['username']->value) {
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="status">
                                        <option value="staff" <?php if ($_smarty_tpl->tpl_vars['status']->value == "staff") {?> selected="selected" <?php }?>>Yönetici</option>
                                        <option value="editor"  <?php if ($_smarty_tpl->tpl_vars['status']->value == "editor") {?> selected="selected" <?php }?>>Editor</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
