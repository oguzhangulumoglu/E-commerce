            ...
            <div class="col-sm-8 col-md-9">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active">
                        ...
                        <form action="{base_url("/main/stock")}" method="get">
                        ...
                        <div class="search-results">
                            <div class="row">
                                ...
                                {foreach from=$list item=product}
                                    ...
                                    <div class="col-md-12" id="ares_empty_stock{$product->pid|get_data:"product":"id"}">
                                        <div class="white-bg">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <figure><img src="{if $product->pid|get_data:"product_img":"image"}{base_url($product->pid|get_data:"product_img":"image")}{else}{base_url("assets/images/no_image.jpg")}{/if}" alt="" style="max-height: 200px" class="img-responsive center-block"></figure>
                                                </div>
                                                <div class="col-md-8">
                                                    <h4>
                                                        <a href="{base_url("/genel/lastik")}/{$product->pid|get_data:"product":"uri"}">
                                                            {$product->pid|get_data:"product":"name"}
                                                        </a>
                                                    </h4>
                                                    <ul>
                                                        <li><span>Marka:</span> {$product->pid|get_data:"product":"brand"|get_data:"brand":"name"}</li>
                                                        <li><span>Cinsi:</span> {$product->pid|get_data:"product":"season"|get_data:"season":"name"}</li>
                                                        <li><span>Kategori:</span> {$product->pid|get_data:"product":"category"|get_data:"category":"name"}</li>
                                                    </ul>
                                                    {if $status == "normal"}
                                                        <form action="{base_url("/main/product_update")}" method="post">
                                                            <input type="hidden" name="id" value="{$product->pid}"/>
                                                            <input type="hidden" name="link" value="{base_url("main/stock")}"/>
                                                            <div class="form-group">
                                                                <label for="">Yıl:</label>
                                                                <input type="text" name="year" value="{$product->pid|urunyili}" class="form-control" placeholder="2011" required="">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="stock" value="{$product->stock}" class="form-control" placeholder="0" required="">
                                                            </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="price">
                                                        ...
                                                        <span>{$product->pid|get_max_amount}</span>
                                                        <a style="background:#dd0000;color:#fff;padding:5px;border-radius:5px;cursor:pointer;" href="javascript:deleteStock({$product->pid})">Stoğu boşalt</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
