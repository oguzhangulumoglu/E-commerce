<?php
/* Smarty version 3.1.29, created on 2022-08-16 20:59:19
  from "/home/admin/web/lastikkent.com.tr/public_html/application/views/admin/sales_option.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_62fbdaf76a7a79_39371819',
  'file_dependency' => 
  array (
    '9d9e5b9411639b4465c17a1e4b906135a85a379b' => 
    array (
      0 => '/home/admin/web/lastikkent.com.tr/public_html/application/views/admin/sales_option.tpl',
      1 => 1492518465,
      2 => 'file',
    ),
  ),
...
function content_62fbdaf76a7a79_39371819 ($_smarty_tpl) {
...
"><svg class="glyph stroked home"><use xlink:href="#stroked-home"></use></svg></a></li>
                <li><a href="<?php echo base_url("admin/sales");?>
"> Lastik Satıcı</a></li>
                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="sales" value="<?php if ($_smarty_tpl->tpl_vars['name']->value) {
echo $_smarty_tpl->tpl_vars['name']->value;
}?>" placeholder="Lastik satıcı adı">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
