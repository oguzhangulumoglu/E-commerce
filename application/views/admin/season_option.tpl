    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{base_url("admin/season")}"> Mevsim</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Mevsim</h1>
            </div>
        </div>
                        ...
                        <form role="form" method="post">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="season" value="{if $name}{$name}{/if}" placeholder="Mevsim tipi">
                                </div>
                            </div>
                            <div class="col-md-6">
