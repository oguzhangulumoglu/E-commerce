    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{base_url("admin/tire_width")}"> Lastik genişliği</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Lastik genişliği</h1>
            </div>
        </div>
                        ...
                        <form role="form" method="post">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Lastik genişliği</label>
                                    <input class="form-control" type="text" name="tire_width" value="{if $name}{$name}{/if}" placeholder="Lastik genişliği">
                                </div>
                            </div>
                            <div class="col-md-6">
