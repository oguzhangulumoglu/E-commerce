    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{base_url("admin/model")}"> Araç Marka</a></li>
                    ...
                    <div class="panel-body">
                        <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="make_id" id="" class="form-control">
                                        ...
                                        {foreach from=$car item=cars}
                                            <option value="{$cars->id}" {if $data["make_id"] eq $cars->id}selected="selected"{/if}>{$cars->title}</option>
                                        {/foreach}
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>İsim</label>
                                    <input class="form-control" type="text" name="title" value="{if $data["title"]}{$data["title"]}{/if}" placeholder="Seat Leon">
                                </div>
                            </div>
                            <div class="col-md-6">
