            ...
            <form name="register" class="row" method="post" role="form" data-toggle="validator">
                ...
                {if $error["code"] eq 2}
                    <div class="alert bg-primary" role="alert">
                        {$error["msg"]}<a href="{base_url("main/register/kurumsal")}" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a>
                    </div>
                {/if}
                <div class="col-md-6 form-group">
                    ...
                    <select class="form-control" name="status" id="status">
                        <option value="normal" {if $smarty.post.status eq "normal"}selected{/if}>Lastik Bayisi</option>
                        <option value="online" {if $smarty.post.status eq "online"}selected{/if}>Online Üye</option>
                    </select>
                </div>
                <div class="col-md-6 form-group">
                    <label>SORUMLU AD SOYAD <span style="color: #d0202a;font-size: 10px;display: inline-block;vertical-align: text-top;">(*)</span></label>
                    <input type="text" name="name" value="{$smarty.post.name}" class="form-control" required="true"/>
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="company" value="{$smarty.post.company}" class="form-control" required="true">
                </div>
                <div class="col-md-6 form-group">
                    <label for="">VERGİ NO</label>
                    <input type="text" id="tc" name="vergino" value="{$smarty.post.vergino}" class="form-control">
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="web" value="{if $smarty.post.web eq ""}http://{else}{$smarty.post.web}{/if}" class="form-control">
                </div>
                <div class="col-md-6 form-group">
