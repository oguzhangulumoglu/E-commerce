    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{base_url("admin/seo")}"> Ayarlar</a></li>
                        ...
                        <form role="form" method="post">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Tag</label>
                                    <input class="form-control" type="text" name="tag" value="{if $tag}{$tag}{/if}" placeholder="tag" disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <textarea class="form-control" name="name" id="" cols="30" rows="10">{if $name}{$name|addslashes}{/if}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
