    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{base_url("admin/tire_rate")}"> Lastik oranı</a></li>
                        ...
                        <form role="form" method="post">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Lastik oranı</label>
                                    <input class="form-control" type="text" name="tire_rate" value="{if $name}{$name}{/if}" placeholder="Lastik oranı">
                                </div>
                            </div>
                            <div class="col-md-6">
